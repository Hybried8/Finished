...
let succ = document.getElementById('registerSuccess');
    ...
    return;
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if(response == "0000"){
                    succ.innerHTML = "Account created successfully!";
                
                }
            },
            error: (e)=>{
                console.error('the error is from here');
            }
